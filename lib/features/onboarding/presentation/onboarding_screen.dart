...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  static const _slides = [
    (Icons.savings, 'Save together, grow together',
        'Join savings circles with classmates and build financial habits.'),
    (Icons.credit_score, 'Loans in minutes, not days',
        'Apply for micro-loans backed by your savings history.'),
    (Icons.verified_user, 'Your financial future starts here',
                ...
                return Padding(
                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Container(
                      ...
                      decoration: BoxDecoration(color: primary100, borderRadius: radius24),
                      child: Icon(s.$1, size: 60, color: primary500),
                    ),
                    const SizedBox(height: sp32),
                    Text(s.$2, style: AppTextStyles.titleLarge, textAlign: TextAlign.center),
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: List.generate(3, (i) =>
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: _page == i ? primary500 : gray300, borderRadius: radiusPill),
                ))),
              const SizedBox(height: sp24),
              FBButton(label: _page == 2 ? 'Get Started' : 'Next', onPressed: _next),
            ]),
          ),
        ]),
      ),
