                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: data.user.kycLevel >= 2
                            ? success100
                            : warning100,
                        borderRadius: radiusPill,
                      ),
                      child: Text(
                        'KYC Level ${data.user.kycLevel}',
                ...
                child: FBCard(
                  child: Column(
                    ...
                    children: [
                      ...
                      _ScoreBar(
                        'Savings consistency',
                        data.healthScore.savingsConsistency,
                      ),
                      _ScoreBar(
                        'Loan repayment',
                        data.healthScore.loanRepaymentRate,
                      ),
                      _ScoreBar(
                        'Challenges',
                        data.healthScore.challengeCompletions / 5,
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Unlock higher limits and loans',
                              style: AppTextStyles.caption.copyWith(
                                color: gray500,
                              ),
                            ),
