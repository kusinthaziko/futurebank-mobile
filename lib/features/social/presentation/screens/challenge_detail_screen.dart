...
class _ChallengeBody extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final daysLeft = challenge.endsAt != null
        ? DateTime.now()
              .difference(DateTime.parse(challenge.endsAt!))
              .inDays
              .abs()
        : 0;
        ...
        if (challenge.joined) ...[
          ...
          FBCard(
            child: Column(
              ...
              children: [
                Text(
                  'Your Progress: Day ${challenge.currentProgress} of ${challenge.targetProgress}',
                ...
                Row(
                  ...
                  children: List.generate(
                    challenge.targetProgress.clamp(1, 15),
                    (i) {
                  ...
                  (e) => Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(width: sp8),
                        Icon(
                          e.rank <= 3 ? Icons.emoji_events : Icons.person,
                          size: 16,
                          color: e.rank == 1 ? gold500 : gray500,
                        ),
                        const SizedBox(width: sp8),
                        Expanded(
                          child: Text(
