      ...
      body: Center(
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text("You've earned",
                style: AppTextStyles.titleMedium.copyWith(color: white.withValues(alpha: 0.8))),
            ...
            Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text('+$pointsAdded pts',
                    style: AppTextStyles.titleLarge.copyWith(color: success500)),
              ]),
            ),
            const Spacer(),
            FBButton(
