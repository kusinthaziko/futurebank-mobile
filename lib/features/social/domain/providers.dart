...
final socialProvider = FutureProvider.autoDispose
    .family<
      ({
...
final challengeDetailProvider = FutureProvider.autoDispose
    .family<ChallengeDetailModel, String>((ref, challengeId) async {
      final token = ref.watch(accessTokenProvider);
      return ref
          .read(socialRepositoryProvider(token))
...
final leaderboardListProvider = FutureProvider.autoDispose
    .family<List<LeaderboardEntry>, ({String institutionId, String period})>((
      ref,
      params,
    ) async {
      final token = ref.watch(accessTokenProvider);
      return ref
          .read(socialRepositoryProvider(token))
          .fetchLeaderboard(params.institutionId, params.period);
    });
