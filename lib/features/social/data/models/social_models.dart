...
class GroupDetailModel {
  ...
  GroupDetailModel({
    ...
    this.inviteCode, this.poolAccountId, this.poolBalance = '0',
    this.memberCount = 0, this.goal, this.groupType = 'Savings Circle',
    this.topContributors = const [], this.recentActivity = const [],
  });
...
class Contributor {
  ...
  Contributor({
    ...
    required this.totalContributed, this.avatarUrl,
  });
...
class GroupActivity {
  ...
  GroupActivity({
    required this.userId, required this.fullName,
    required this.action, this.amount = '', required this.createdAt,
  });
...
class ChallengeDetailModel {
  ...
  ChallengeDetailModel({
    ...
    required this.challengeType, required this.rewardPoints,
    required this.status, this.endsAt,
    this.participantCount = 0, this.leaderboard = const [],
    this.currentProgress = 0, this.targetProgress = 1, this.joined = false,
  });
