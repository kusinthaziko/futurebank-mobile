...
class AccountRepository {
  ...
  Future<({List<AccountModel> accounts, List<SavingsGoalModel> goals})>
  fetchAccounts() async {
    ...
    try {
      ...
      final accounts = (r.data!['myAccounts'] as List)
          .cast<Map<String, dynamic>>()
          .map(map)
          .toList();
      final goals = (r.data!['savingsGoals'] as List)
          .cast<Map<String, dynamic>>()
          .map(mapGoal)
          .toList();
  ...
  Future<List<TxModel>> fetchTransactions(
    ...
    try {
      ...
      if (r.hasException) throw r.exception!;
      final txs = (r.data!['transactionHistory'] as List)
          .cast<Map<String, dynamic>>()
          .map(
            (t) => TxModel.fromJson({
              'id': t['id'],
