...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  Widget _buildStep2() => Padding(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      FBButton(
        label: 'Continue',
        onPressed: _fullName.text.isNotEmpty && _studentId.text.isNotEmpty
            ? () => setState(() => _step = 2)
            : null,
      ),
    ]),
  ...
  Widget _buildStep3() => Padding(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      const SizedBox(height: sp8),
      Text('Use your institution email if possible.',
          style: AppTextStyles.bodyMedium.copyWith(color: gray500)),
      const SizedBox(height: sp32),
      FBInput(label: 'Email', hint: 'you@university.ac.mw',
