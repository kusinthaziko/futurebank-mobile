...
final transactionListItem = CatalogItem(
  ...
  dataSchema: S.object(
    description: 'Show recent transactions. Use when user asks about recent transactions or spending history. Max 5 items.',
    properties: {
      'transactions': S.list(
      ...
      'has_more': S.boolean(description: 'True if user has more than 5 transactions'),
    },
    required: ['transactions'],
  ),
  widgetBuilder: (ctx) {
    final json = ctx.data as Map<String, Object?>;
    final items = (json['transactions'] as List<Object?>?)
