...
final spendingChartItem = CatalogItem(
  ...
  dataSchema: S.object(
    description:
        'Show spending categories breakdown. Use when user asks "where does my money go?" or wants spending analysis.',
    properties: {
      'categories': S.list(
  ...
  widgetBuilder: (ctx) {
    ...
    final categories =
        (json['categories'] as List<Object?>?)?.cast<Map<String, Object?>>() ??
        [];
