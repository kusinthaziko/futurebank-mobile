...
final loanStatusItem = CatalogItem(
  name: 'LoanStatusCard',
  dataSchema: S.object(
    description: 'Show loan status and repayment progress. Use when user asks about their loan or repayment status.',
    properties: {
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(color: statusBg, borderRadius: radiusPill),
