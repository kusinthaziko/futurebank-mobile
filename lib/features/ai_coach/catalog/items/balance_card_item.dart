...
final balanceCardItem = CatalogItem(
  ...
  dataSchema: S.object(
    description:
        'Show the user\'s current account balance with monthly change. Use when user asks about their balance or overall financial state.',
    properties: {
      'balance': S.string(description: 'Formatted balance e.g. "MWK 24,500"'),
      'monthly_change': S.string(
        description: 'Change this month e.g. "+MWK 3,200"',
      ),
