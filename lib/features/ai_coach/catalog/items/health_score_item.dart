...
final healthScoreItem = CatalogItem(
  ...
  dataSchema: S.object(
    description:
        'Show financial health score with tier. Use when user asks about health score, financial standing, or creditworthiness.',
    properties: {
      'score': S.integer(description: '0-1000'),
      'tier': S.string(description: 'Poor | Fair | Good | Excellent | Elite'),
      'breakdown': S.object(
        description: 'Score breakdown categories',
        properties: {
          'payments': S.integer(),
          'savings': S.integer(),
          'spending': S.integer(),
